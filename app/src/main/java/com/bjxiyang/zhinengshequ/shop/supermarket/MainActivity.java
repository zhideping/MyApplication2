...
//            goodsAdapter = new GoodsAdapter(this, list2, catograyAdapter);
    ...
    private View createMealDetailView(List<ItemBean> listItem, String mealName){
        View view = LayoutInflater.from(this).inflate(R.layout.activity_super_goods_detail,(ViewGroup) getWindow().getDecorView(),false);
...
//        tv_num.setText("(共"+count+"件)");
    ...
    private View createBottomSheetView(){
        View view = LayoutInflater.from(this).inflate(R.layout.super_layout_bottom_sheet,(ViewGroup) getWindow().getDecorView(),false);
