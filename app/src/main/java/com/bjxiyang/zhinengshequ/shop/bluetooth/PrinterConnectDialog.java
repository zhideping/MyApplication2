...
import com.bjxiyang.zhinengshequ.shop.activity.MySwipeBackActivity;
...
public class PrinterConnectDialog extends MySwipeBackActivity {
...
//        requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
    ...
    private void initView() {
        rl_fanhui= (RelativeLayout) findViewById(R.id.rl_fanhui);
